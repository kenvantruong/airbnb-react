            ...
            return (
              ...
              <div className="listing">
                  ...
                  <div className="details">
                    ...
                    <div className="col-md-9">
                      <div className="user-details">
                        <span className="user-name">Nina Smith is your Host</span>
                        <span className="post-date">06/25/2018</span>
                      </div>
                ...
                <div className="bottom-info">
                  <span className="price">${listing.price}.00/night</span>
  ...
  render () {
    ...
    <section id="listings">
      <section className="search-area">
        <input type="text" placeholder="Search..." className="search-style" name="search" onChange={this.props.change}/>
      </section>
